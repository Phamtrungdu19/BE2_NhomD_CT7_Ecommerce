<div>
  ...
  <div class="py-3 py-md-5 bg-light">
    <div class="container">
<h2 style="margin-top: 10px; margin-bottom: 10px">Cart Pages</h2>
        <div class="row">
            <div class="col-md-12">
                     ...
                     <div class="cart-item">
                        <div class="row">
                            <div class="col-md-4 my-auto">
                                <a href="{{url('collections/'. $cartItem->product->category->slug.'/'.$cartItem->product->slug)}}">
                                    <label class="product-name">
                                        <img src="{{asset($cartItem->product->productsImages[0]->image)}}" style="width: 80px; height: 50px" alt="">
                            ...
                            <div class="col-md-2 my-auto">
                                <label class="price">{{ $cartItem->product->selling_price}} VND</label>
                            ...
                            <div class="col-md-2 my-auto" >
                                <label class="total">{{ $cartItem->product->selling_price*$cartItem->quantity}} VND</label>
                                @php
        ...
        <div class="row">
            <div class="col-md-8 my-md-auto mt-3">
                Get the best deals & Offers <a href="{{url('/collection')}}">Show now</a>
            </div>
            <div class="col-md-4">
